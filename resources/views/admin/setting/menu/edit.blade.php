        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">修改页头菜单</h3>
                </div>
                <div class="card-body" id="vue-edit-header-menu">
                    <form action="/admin/setting/menu/create" method="post" @@submit.prevent="submit">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <div class="form-label">隐藏菜单</div>
                                <label class="form-check form-switch">
                                    <input class="form-check-input" v-model="data.hidden" type="checkbox" >
                                    <span class="form-check-label">设置菜单状态为不可见</span>
                                </label>
                            </div>
                            <div class="col-lg-12">
