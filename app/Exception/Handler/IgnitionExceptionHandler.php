...
class IgnitionExceptionHandler extends ExceptionHandler
{
    ...
    {
        $whoops = \Spatie\Ignition\Ignition::make()->register();
    ...
    {
        return env('APP_ENV') !== 'prod' && class_exists(\Spatie\Ignition\Ignition::class);
    }
