...
Itf()->add('users_notices', 1, [
   ...
   <line x1="3" y1="17" x2="21" y2="17"></line>
    ...
    'count' => \Opis\Closure\serialize(function ($user_id) {
        return UsersNotice::query()->where(['user_id' => $user_id, 'status' => 'publish', 'sort' => null])->count();
    }),
]);
...
Itf()->add('users_notices', 2, [
   ...
   <path d="M3 6.727a11.05 11.05 0 0 1 2.792 -3.727"></path>
    ...
    'count' => \Opis\Closure\serialize(function ($user_id) {
        return UsersNotice::query()->where(['user_id' => $user_id, 'status' => 'publish', 'sort' => 'system'])->count();
    }),
]);
