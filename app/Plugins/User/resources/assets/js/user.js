...
"use strict";
/*!*******************************************!*\
  !*** ./resources/js/plugins/User/user.js ***!
  \*******************************************/
  ...
  var vucc = {
    ...
    methods: {
      submit: function submit() {
        axios__WEBPACK_IMPORTED_MODULE_0___default().post("/admin/userClass/create", {
          _token: csrf_token,
          name: this.name,
          icon: this.icon,
          color: this.color,
...
if (document.getElementById("vue-user-edit-class")) {
  var vsec = {
    ...
    methods: {
      submit: function submit() {
        axios__WEBPACK_IMPORTED_MODULE_0___default().post("/admin/userClass/update", {
          id: this.id,
          _token: csrf_token,
          name: this.name,
          icon: this.icon,
    ...
    methods: {
      ...
      token: function token(id, _token) {
        sweetalert__WEBPACK_IMPORTED_MODULE_1___default()({
          ...
          if (r === true) {
            axios__WEBPACK_IMPORTED_MODULE_0___default().post("/admin/users/update/token", {
              _token: csrf_token,
              user_id: id
            }).then(function (r) {
              var data = r.data;
    ...
    methods: {
      download: function download(url) {
        sweetalert__WEBPACK_IMPORTED_MODULE_1___default()({
          ...
          if (r) {
            downloadjs__WEBPACK_IMPORTED_MODULE_3___default()(url);
          }
        });
      },
      remove: function remove(id) {
        sweetalert__WEBPACK_IMPORTED_MODULE_1___default()({
          ...
          if (r === true) {
            axios__WEBPACK_IMPORTED_MODULE_0___default().post("/api/User/Files/remove", {
              id: id,
              _token: csrf_token
            }).then(function (r) {
              var data = r.data;
