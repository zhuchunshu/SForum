...
/***/ "./resources/js/plugins/User/pm.js":
/*!*****************************************!*\
  !*** ./resources/js/plugins/User/pm.js ***!
  \*****************************************/
  ...
  var app = {
    ...
    methods: {
      ...
      sendMsg: function sendMsg() {
        ...
        axios__WEBPACK_IMPORTED_MODULE_0___default().post("/api/user/pm/send_msg", {
          _token: csrf_token,
          user_id: to_id,
          content: this.msg
        }).then(function (r) {
          ...
          if (data.success === false) {
            sweetalert__WEBPACK_IMPORTED_MODULE_1___default()('发送失败', data.result.msg, 'error');
            return;
          }

          _this4.btn.disabled = _this4.btn.disabled === false;
          _this4.msg = null;
      ...
      get_msg: function get_msg() {
        ...
        axios__WEBPACK_IMPORTED_MODULE_0___default().post("/api/user/pm/get_msg", {
          _token: csrf_token,
          user_id: to_id
        }).then(function (r) {
          var data = r.data;
          ...
          if (data.success === false) {
            sweetalert__WEBPACK_IMPORTED_MODULE_1___default()('获取失败', data.result.msg, 'error');
            return;
          }

          _this5.messages = data.result.message;
        })["catch"](function (e) {
          sweetalert__WEBPACK_IMPORTED_MODULE_1___default()('获取失败', '网络请求错误', 'error');
          console.error(e);
        });
      }
    }
...
/******/ 	var __webpack_exports__ = __webpack_require__("./resources/js/plugins/User/pm.js");
/******/ 	
/******/ })()
;