...
{{--                qq--}}
                @if($user->options->qq)
                <div class="col-12 col-md-6 col-lg-3">
                    <div class="card card-sm" data-bs-toggle="popover" data-bs-placement="top" title="QQ" data-bs-content="{{ (string)$user->options->qq }}">
                        <div class="card-body">
                            <div class="row align-items-center">
                                <div class="col-auto">
                            <span class="bg-orange-lt text-white avatar"><!-- Download SVG icon from http://tabler-icons.io/i/heart -->
   ...
   <path d="M16 21c1.5 0 3.065 -1 1 -3c4.442 2 1.987 -4.5 1 -7c0 -4 -1.558 -8 -6 -8s-6 4 -6 8c-.987 2.5 -3.442 9 1 7c-2.065 2 -.5 3 1 3h8z"></path>
                ...
                @if($user->options->wx)
                    <div class="col-12 col-md-6 col-lg-3">
                        <div class="card card-sm" data-bs-toggle="popover" data-bs-placement="top" title="{{ __('user.wechat') }}" data-bs-content="{{ (string)$user->options->wx }}">
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col-auto">
                            <span class="bg-orange-lt text-white avatar"><!-- Download SVG icon from http://tabler-icons.io/i/heart -->
   ...
   <path d="M12 2l.24 .004a7 7 0 0 1 6.76 6.996l-.003 .193l-.007 .192l-.018 .245l-.026 .242l-.024 .178a6.985 6.985 0 0 1 -.317 1.268l-.116 .308l-.153 .348a7.001 7.001 0 0 1 -12.688 -.028l-.13 -.297l-.052 -.133l-.08 -.217l-.095 -.294a6.96 6.96 0 0 1 -.093 -.344l-.06 -.271l-.049 -.271l-.02 -.139l-.039 -.323l-.024 -.365l-.006 -.292a7 7 0 0 1 6.76 -6.996l.24 -.004z" stroke-width="0" fill="currentColor"></path>
                                    ...
                                    <div class="col">
                                        <div class="font-weight-medium">
                                            <div class="text-truncate text-truncate-end">
                                                <div class="avatar-list avatar-list-stacked" data-bs-toggle="modal" data-bs-target="#modal-user-moderator">
                                                    @foreach($user->moderator as $moderator)
                                                        <span class="avatar avatar-rounded bg-azure-lt" style="--tblr-avatar-size:25px;">
                                                        {!! $moderator->tag->icon !!}
                                                    </span>
                                                    @endforeach
                                                </div>
