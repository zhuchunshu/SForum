    ...
    methods: {
      Logout: function Logout() {
        axios__WEBPACK_IMPORTED_MODULE_0___default().post("/logout", {
          ...
          sweetalert__WEBPACK_IMPORTED_MODULE_1___default()("请求错误,详细查看控制台");
          console.log(error);
        });
      }
    }
...
$(function () {
  ...
  $('a[core-click="copy"]').click(function () {
    var content = $(this).attr("copy-content");
    copy_to_clipboard__WEBPACK_IMPORTED_MODULE_3___default()(content);
    var message = "复制成功";
