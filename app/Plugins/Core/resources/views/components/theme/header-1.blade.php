...
@section('content')
    ...
    <header id="app-header" class="text-gray-600 body-font">
                ...
                <div class="flex flex-col md:flex-row md:justify-between md:items-center">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                            <a class="text-2xl font-bold text-gray-800 dark:text-white lg:text-3xl hover:text-gray-700 dark:hover:text-gray-300" href="#">{{get_options("web_name","CodeFec")}}</a>
                        ...
                        <!-- Mobile menu button -->
                        <div class="flex md:hidden" @@click="menu">
                    ...
                    <div id="app-mobile-menu" class="items-center md:flex hidden">
