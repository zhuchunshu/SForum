...
@section('content')
    <div class="col-md-12">
        <div class="card" id="vue-user-topic-tag-create">
            <div class="card-header">
                <ol class="breadcrumb breadcrumb-arrows" aria-label="breadcrumbs">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><a href="#">创建</a></li>
                </ol>
            </div>
            <div class="card-body">
                <h3 class="card-title">{{__("tag.create tag")}}</h3>
                <form method="post" action="/tags/create?Redirect=/tags/create" @@submit.prevent="submit"
                    ...
                    <div class="mb-3">
                        <div class="row">
                            <div class="col-6">
                                ...
                                <input type="color" class="form-control form-control-color" name="color" v-model="color"
                                       required>
                            </div>
                        </div>
                    </div>
                        ...
                        @foreach($userClass as $value)
                            <div class="col-4">
                                <label class="form-check form-switch">
                                    <input name="userClass[]" value="{{$value['name']}}" class="form-check-input"
                                           type="checkbox">
