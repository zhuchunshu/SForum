  ...
  var vttt = {
    methods: {
      remove: function remove(id) {
        axios__WEBPACK_IMPORTED_MODULE_0___default().post("/admin/topic/tag/remove", {
          _token: csrf_token,
          id: id
  ...
  var app = {
    methods: {
      ...
      approval: function approval(id) {
        axios__WEBPACK_IMPORTED_MODULE_0___default().post("/admin/topic/tag/job/approval", {
          _token: csrf_token,
          id: id
        }).then(function (response) {
          var data = response.data;
      ...
      reject: function reject(id) {
        sweetalert__WEBPACK_IMPORTED_MODULE_1___default()("驳回理由:", {
          content: "input",
          buttons: true
        }).then(function (value) {
          if (value !== null) {
            axios__WEBPACK_IMPORTED_MODULE_0___default().post("/admin/topic/tag/job/reject", {
              _token: csrf_token,
              id: id,
              content: value
            }).then(function (response) {
