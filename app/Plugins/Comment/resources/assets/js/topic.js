  ...
  var topic_comment = {
    ...
    mounted: function mounted() {
      ...
      this.vditor = new (vditor__WEBPACK_IMPORTED_MODULE_0___default())('topic-comment', {
        ...
        mode: this.edit.mode,
        toolbar: ["headings", "bold", "italic", "strike", "link", "|", "quote", "line", "code", "inline-code", "insert-before", "insert-after", "|", "table", {
          hotkey: '⌘-⇧-V',
          name: 'video',
          tipPosition: 's',
          tip: '插入视频',
          ...
          click: function click() {
            swal("请输入视频链接:", {
              ...
              if (value) {
                ...
                _this2.vditor.insertValue(content);
              }
            });
          }
        }, "undo", "redo", "|", "edit-mode"],
...
var template = document.getElementById('template'); // 评论点赞
  ...
  $('a[comment-click="comment-reply-topic"]').click(function () {
    ...
    if (vditor_dom.attr("comment-status") === "off") {
      var vditor = new (vditor__WEBPACK_IMPORTED_MODULE_0___default())('comment-reply-vditor-' + comment_id, {
        ...
        toolbar: ["headings", "bold", "italic", "strike", "link", "|", "quote", "line", "code", "inline-code", "insert-before", "insert-after", "|", {
          hotkey: '⌘-⇧-V',
          name: 'video',
          tipPosition: 's',
          tip: '插入视频',
