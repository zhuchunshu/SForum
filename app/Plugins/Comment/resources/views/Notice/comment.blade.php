        ...
        <div class="col-md-12">
            <div class="row">
                ...
                <div class="col text-truncate">
                    ...
                    <br>
                    <small data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="{{$data->created_at}}" class="text-muted text-truncate mt-n1">发表于:发表于:{{$data->created_at}}</small>
                </div>
            </div>
        </div>
        <div class="col-md-12">
