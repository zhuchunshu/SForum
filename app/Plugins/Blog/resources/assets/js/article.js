  ...
  var app = {
    ...
    methods: {
      init: function init() {
        ...
        axios__WEBPACK_IMPORTED_MODULE_1___default().post("/api/Blog/article/class", {
          _token: csrf_token
        ...
        this.vditor = new (vditor__WEBPACK_IMPORTED_MODULE_0___default())('content-vditor', {
          ...
          toolbar: ["emoji", "headings", "bold", "italic", "strike", "link", "|", "list", "ordered-list", "|", "line", "insert-before", "insert-after", "table", "|", "fullscreen", "edit-mode"],
          counter: {
            "enable": true,
            "type": "已写字数"
          },
      ...
      submit: function submit() {
        ...
        axios__WEBPACK_IMPORTED_MODULE_1___default().post("/api/Blog/article/create", {
          _token: csrf_token,
          markdown: markdown,
          title: title,
          content: content,
    ...
    watch: {
      title: function title(_title) {
        localStorage.setItem("blog_article_create_title", _title);
      },
      class_id: function class_id(_class_id) {
        localStorage.setItem("blog_article_create_class_id", _class_id);
      }
    }
  };
...
if (document.getElementById('vue-blog-article-edit')) {
    ...
    methods: {
      init: function init() {
        ...
        axios__WEBPACK_IMPORTED_MODULE_1___default().post("/api/Blog/article/class", {
          ...
          _this3.classList = response.data;
        })["catch"](function (e) {
          console.error(e);
        }); // vditor
        ...
        this.vditor = new (vditor__WEBPACK_IMPORTED_MODULE_0___default())('content-vditor', {
          ...
          after: function after() {
            axios__WEBPACK_IMPORTED_MODULE_1___default().post("/api/Blog/open/article/data", {
              id: _this3.article_id
            }).then(function (response) {
              _this3.title = response.data.title;
              _this3.class_id = response.data.class_id;

              _this3.vditor.setValue(response.data.markdown);
            })["catch"](function (e) {
              console.error(e);
            });
          },
      ...
      submit: function submit() {
        ...
        axios__WEBPACK_IMPORTED_MODULE_1___default().post("/api/Blog/article/edit", {
          id: this.article_id,
          _token: csrf_token,
          markdown: markdown,
          title: title,
  ...
  Vue.createApp(_app).mount('#vue-blog-article-edit');
}
})();
