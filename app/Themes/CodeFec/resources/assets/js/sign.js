...
"use strict";
/*!*******************************************!*\
  !*** ./resources/js/plugins/Core/sign.js ***!
  \*******************************************/
...
if (document.getElementById("vue-core-sign-login-username")) {
  var app = {
    ...
    methods: {
      submit: function submit() {
        axios__WEBPACK_IMPORTED_MODULE_0___default().post("/login/username", {
          _token: csrf_token,
          username: this.username,
          password: this.password,
          captcha: this.captcha
...
if (document.getElementById("vue-core-forgot-password")) {
  var _app = {
    ...
    methods: {
      sendCode: function sendCode() {
        ...
        axios__WEBPACK_IMPORTED_MODULE_0___default().post("/forgot-password/sendCode", {
          _token: csrf_token,
          email: this.email,
          captcha: this.captcha
        }).then(function (response) {
      ...
      submit: function submit() {
        ...
        axios__WEBPACK_IMPORTED_MODULE_0___default().post("/forgot-password/verifyCode", {
          _token: csrf_token,
          code: this.YzCode
        }).then(function (response) {
          var data = response.data;
          ...
          if (data.success === true) {
            ...
            _this2.sendCoded = !_this2.sendCoded;
          } else {
            if (data.result instanceof Array) {
              var content = "";
              data.result.forEach(function (element) {
      ...
      // 设置新密码
      setPwdSubmit: function setPwdSubmit() {
        var _this3 = this;
        ...
        axios__WEBPACK_IMPORTED_MODULE_0___default().post("/forgot-password", {
          _token: csrf_token,
  ...
  Vue.createApp(_app).mount("#vue-core-forgot-password");
}
})();
