<div id="carousel-{{$id}}-thumb-vertical" class="carousel slide carousel-fade" data-bs-ride="carousel">
    <div class="carousel-indicators carousel-indicators-vertical carousel-indicators-thumb">
        @foreach($images as $key=>$item)
            @if($loop->first)
                <button type="button" data-bs-target="#carousel-{{$id}}-thumb-vertical" data-bs-slide-to="0"
                        class="ratio ratio-4x3 active" style="background-image: url({{$item->image}})"></button>
            @else
                <button type="button" data-bs-target="#carousel-{{$id}}-thumb-vertical" data-bs-slide-to="1"
