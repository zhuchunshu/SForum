...
SForum is a forum project in the planning stage.

The repository currently contains project documentation, collaboration rules, and a lightweight knowledge base so future sessions can continue from shared context before implementation begins.
