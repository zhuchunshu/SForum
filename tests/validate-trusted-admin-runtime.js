...
const supervisor = read('apps/web/scripts/runtime.mjs')
...
assert(supervisor.includes('web-release-contract') && releaseContract.includes('active.json') && releaseContract.includes('failures'), 'Supervisor must acknowledge active and failed releases')
