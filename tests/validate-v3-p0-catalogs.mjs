...
assert(routes.length === 342, `route inventory must contain exactly 342 reviewed routes: ${routes.length}`)
...
assert(ui.length === 290, `UI inventory must contain exactly 290 reviewed surfaces: ${ui.length}`)
