...
assert(routes.length === 244, `route inventory must contain exactly 244 reviewed routes: ${routes.length}`)
...
assert(ui.length === 127, `UI inventory must contain exactly 127 reviewed surfaces: ${ui.length}`)
