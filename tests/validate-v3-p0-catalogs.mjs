...
assert(routes.length === 229, `route inventory must contain exactly 229 reviewed routes: ${routes.length}`)
...
assert(ui.length === 121, `UI inventory must contain exactly 121 reviewed surfaces: ${ui.length}`)
