...
assert(routes.length === 327, `route inventory must contain exactly 327 reviewed routes: ${routes.length}`)
...
assert(ui.length === 267, `UI inventory must contain exactly 267 reviewed surfaces: ${ui.length}`)
