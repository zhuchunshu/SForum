...
assert(routes.length === 296, `route inventory must contain exactly 296 reviewed routes: ${routes.length}`)
...
assert(ui.length === 234, `UI inventory must contain exactly 234 reviewed surfaces: ${ui.length}`)
