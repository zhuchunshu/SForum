...
assert(routes.length === 242, `route inventory must contain exactly 242 reviewed routes: ${routes.length}`)
...
assert(ui.length === 126, `UI inventory must contain exactly 126 reviewed surfaces: ${ui.length}`)
