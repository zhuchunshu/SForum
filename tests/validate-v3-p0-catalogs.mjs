...
assert(routes.length === 241, `route inventory must contain exactly 241 reviewed routes: ${routes.length}`)
...
assert(ui.length === 125, `UI inventory must contain exactly 125 reviewed surfaces: ${ui.length}`)
