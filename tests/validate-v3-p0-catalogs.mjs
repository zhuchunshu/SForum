...
assert(routes.length === 231, `route inventory must contain exactly 231 reviewed routes: ${routes.length}`)
...
assert(ui.length === 123, `UI inventory must contain exactly 123 reviewed surfaces: ${ui.length}`)
