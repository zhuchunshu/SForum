...
Status: **active implementation; P0-P4 complete, P5 active**
Date: 2026-07-13  
...
- [ ] CLI command is unavailable in safe mode unless explicitly recovery-safe.
- [ ] Job/schedule disable and upgrade drain behavior.
