...
if (document.getElementById('vue-admin-hook-component-edit')) {
  var app = {
    ...
    mounted: function mounted() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().get(get_action).then(function (r) {
        var data = r.data;

        if (data.success === true) {
          _this.ace.session.setValue(data.result.content);
    ...
    methods: {
      submit: function submit() {
        ...
        axios__WEBPACK_IMPORTED_MODULE_0___default().post(put_action, {
          _token: csrf_token,
          content: content
        }).then(function (r) {
          var data = r.data;
...
if (document.getElementById('vue-admin-hook-component-create')) {
  var _app = {
    ...
    methods: {
      submit: function submit() {
        if (!this.name) {
          sweetalert__WEBPACK_IMPORTED_MODULE_1___default()('Error', '小部件名称不能为空', 'error');
          return;
        }

        var content = this.ace.getValue();
        axios__WEBPACK_IMPORTED_MODULE_0___default().post(create_action, {
          _token: csrf_token,
          name: this.name,
          content: content
        }).then(function (r) {
  ...
  Vue.createApp(_app).mount("#vue-admin-hook-component-create");
}
...
if (document.getElementById('vue-admin-hook-components')) {
    ...
    methods: {
      ...
      rm: function rm(path) {
        sweetalert__WEBPACK_IMPORTED_MODULE_1___default()({
          ...
          if (willDelete) {
            axios__WEBPACK_IMPORTED_MODULE_0___default().post("/admin/hook/components/delete", {
              _token: csrf_token,
              path: path
            }).then(function (r) {
              var data = r.data;
              ...
              sweetalert__WEBPACK_IMPORTED_MODULE_1___default()("请求出错", {
                icon: "error"
              });
              console.error(e);
            });
  ...
  Vue.createApp(_app2).mount("#vue-admin-hook-components");
}
})();
