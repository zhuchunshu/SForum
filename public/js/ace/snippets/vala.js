ace.define("ace/snippets/vala",["require","exports","module"],function(e,t){"use strict";t.snippets=[{content:`case \${1:condition}:
	$0
	break;
...
`,name:"namespace (ns)",scope:"vala",tabTrigger:"ns"},{content:"stdout.printf($0);",name:"printf",scope:"vala",tabTrigger:"printf"},{content:`\${1:public} \${2:Type} \${3:Name} {
	...
	$0
}`,name:"try/catch",scope:"vala",tabTrigger:"try"},{content:'"""$0""";',name:'Verbatim string (""")',scope:"vala",tabTrigger:"verbatim"},{content:"while ($1) {\n	$0\n}",name:"while",scope:"vala",tabTrigger:"while"}],t.scope=""}),function(){ace.require(["ace/snippets/vala"],function(e){typeof module=="object"&&typeof exports=="object"&&module&&(module.exports=e)})}()