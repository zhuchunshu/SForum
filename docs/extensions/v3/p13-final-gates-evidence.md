...
| Full `go test ./...` re-run after product-path | re-verified | After entity dry-run + localization: Localization gate fixed for `entity.*` codes; full suite re-run captured under session final-gates evidence. |
