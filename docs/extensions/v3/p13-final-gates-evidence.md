...
| Full `go test ./...` re-run after product-path | re-verified green | Localization `entity.*` i18n; catalog inventory **248**; entity dry-run `extension.view` handler + `core.guard.extensions.read` partition; full suite EXIT 0 after guard fix. |
