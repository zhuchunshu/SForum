...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `core.admin.page.attachments` | `apps/web/app/pages/admin/attachments.vue` | yes | no | yes | no | yes | no | no | yes | yes | no | yes | yes | no |
...
| `core.admin.page.moderation` | `apps/web/app/pages/admin/moderation.vue` | yes | no | yes | no | no | no | no | no | no | no | no | yes | no |
| `core.admin.page.permissions` | `apps/web/app/pages/admin/permissions.vue` | yes | no | yes | no | yes | no | no | yes | yes | no | no | yes | no |
| `core.admin.page.personalization` | `apps/web/app/pages/admin/personalization.vue` | yes | no | yes | no | yes | no | no | yes | yes | no | no | yes | no |
| `core.admin.page.roles` | `apps/web/app/pages/admin/roles.vue` | yes | no | yes | yes | yes | yes | no | yes | yes | yes | no | yes | no |
...
| `core.admin.page.seo` | `apps/web/app/pages/admin/seo.vue` | yes | no | yes | no | yes | no | no | yes | yes | no | no | yes | no |
| `core.admin.page.settings_avatar` | `apps/web/app/pages/admin/settings/avatar.vue` | yes | no | yes | no | no | no | no | yes | yes | no | no | yes | no |
| `core.admin.page.settings_features` | `apps/web/app/pages/admin/settings/features.vue` | yes | no | yes | no | no | no | no | yes | yes | no | no | yes | no |
