...
Snapshot (2026-07): core forum, identity, admin, attachments, mail/notifications, moderation, extension platform V3 (P0–P12 done; P13 LTS deletion window only), and default site search are in place. Treat this as directional; details live in `knowledge/plans/` and code.
...
- Manifest V3, trust, lifecycle, Page Registry themes  
