...
func NewController(extensionStore extensions.Store, deliveries notifications.Store, providers *extensionsruntime.MailProviderRegistry, users identity.ActorStore, sessions *authsession.Manager) *Controller {
	return &Controller{extensions: extensionStore, deliveries: deliveries, providers: providers, users: users, sessions: sessions}
}
...
func (h *Controller) authorize(c fiber.Ctx) error {
