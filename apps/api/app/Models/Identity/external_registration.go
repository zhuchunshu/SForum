...
func (s *ExternalAuthService) PrepareExternalRegistration(ctx context.Context, ticket RegistrationTicket) (ExternalRegistrationPreparation, error) {
	...
	assertion := externalAuthAssertionFromRegistrationTicket(ticket)
	assertion.Operation = ticket.SourceOperation
...
func externalAuthAssertionFromRegistrationTicket(ticket RegistrationTicket) ExternalAuthAssertion {
