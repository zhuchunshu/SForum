...
func TestCorePageViewModelCatalogCoversPublicPageFamilies(t *testing.T) {
	...
	want := map[string]PageViewModelKind{
		...
		"forum.settings.profile": ViewModelSettings, "forum.settings.login_methods": ViewModelSettings, "forum.settings.password": ViewModelSettings, "forum.settings.security": ViewModelSettings,
