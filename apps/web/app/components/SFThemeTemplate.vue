...
const islandComponents: Record<string, Component> = {
  ...
  'forum.component.profile_show': resolveComponent('SFProfileShowPage') as Component,
  'forum.component.my_home': resolveComponent('SFMyHomePage') as Component,
  'forum.component.my_content_review': resolveComponent('SFMyContentReviewPage') as Component,
  'forum.component.notifications': resolveComponent('SFNotificationsPage') as Component,
  'site.component.terms': resolveComponent('SFTermsPage') as Component,
  'site.component.privacy': resolveComponent('SFPrivacyPage') as Component,
  'site.component.guidelines': resolveComponent('SFGuidelinesPage') as Component,
