import type { PublicProfile, ProfileActivity as ApiProfileActivity } from '~/composables/useProfileApi'
import type { SiteDateTimeSettings } from './siteDateTime'
import { forumTopicPath, type TopicUrlMode } from './forumTaxonomy'
