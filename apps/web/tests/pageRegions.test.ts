...
import {
  ...
  safePageRegionHref
} from '../app/composables/usePageRegions'
...
describe('region outlet wiring contracts', () => {
  ...
  it('every region page ships its outlets', () => {
    const placements: Record<string, string[]> = {
      'SFHomePage.vue': ['forum.home'],
      'SFTopicShowPage.vue': ['forum.topic.show'],
      'SFCategoryShowPage.vue': ['forum.category.show'],
      'SFCategoryIndexPage.vue': ['forum.category.index'],
      'SFTagShowPage.vue': ['forum.tag.show'],
      'SFTagIndexPage.vue': ['forum.tag.index'],
    ...
    // 有右栏的页面提供 sidebar 区域。
    for (const file of [
      'SFHomePage.vue', 'SFTopicShowPage.vue', 'SFCategoryIndexPage.vue',
      'SFTagShowPage.vue', 'SFTagIndexPage.vue', 'SFProfileShowPage.vue'
    ]) {
