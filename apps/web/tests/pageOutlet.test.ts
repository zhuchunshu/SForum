...
describe('SFPageOutlet catalog wiring', () => {
  ...
  it('routes themeable system errors through the dedicated themed boundary', () => {
    ...
    const systemError = read('app/components/SFSystemErrorPage.vue')
    ...
    const presentation = read('app/composables/useSystemErrorPagePresentation.ts')
    ...
    const systemResolve = read('app/composables/useSystemErrorPageResolve.ts')
    ...
    expect(read('app/components/SFSystemErrorEmergencyPage.vue')).toContain('emergency')
    const errorContent = read('app/components/SFErrorPageContent.vue')
    ...
    const recoveryBody = read('app/components/SFSystemErrorRecovery.vue')
    ...
    const recoveryData = read('app/composables/useSystemErrorRecoveryData.ts')
    ...
    const systemDetails = read('app/components/SFSystemErrorDetails.vue')
