...
} from '../app/utils/forumCategoryDirectory'
import type { ForumCategory, ForumCategoryGroup } from '../app/utils/forumTaxonomy'
...
describe('category directory helpers', () => {
  ...
  test('preserves empty public groups and records current backend ungrouped category semantics', () => {
    ...
    const migration = readFileSync(new URL('../../../apps/api/database/migrations/202607070003_forum_taxonomy.sql', import.meta.url), 'utf8')
